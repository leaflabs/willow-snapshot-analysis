...
class ProbeMap256_P3(QtGui.QLabel):
    ...
    def __init__(self, height, img):
        ...
        self.x_offset = int(330 / self._w * self.scaled_pixmap.width())
        self.dx =       int(31 / self._w * self.scaled_pixmap.width())
        self.y_offset = int(100 / self._h * self.scaled_pixmap.height())
        self.dy =       int(31 / self._h * self.scaled_pixmap.height())
